...
export type StarterDinosaurId = 'triceratops' | 'velociraptor' | 'pteranodon';
...
export const STARTER_DINOSAUR_IDS: StarterDinosaurId[] = ['triceratops', 'velociraptor', 'pteranodon'];
...
function isStarterDinosaurId(value: unknown): value is StarterDinosaurId {
  return STARTER_DINOSAUR_IDS.includes(value as StarterDinosaurId);
}
